...
const List<AchievementBadgeDefinition> staticAchievementBadges = [
  ...
  AchievementBadgeDefinition(
    id: 'first_class_fire',
    name: '화둔',
    condition: '작열 속성 우월코드 합산 상위 4% 이내 달성',
    imagePath: 'assets/icons/elements/icon-elements-Fire.webp',
    comment: '작열 속성 1등급 지휘관입니다.',
  ),
  AchievementBadgeDefinition(
    id: 'first_class_water',
    name: '수둔',
    condition: '수냉 속성 우월코드 합산 상위 4% 이내 달성',
    imagePath: 'assets/icons/elements/icon-elements-Water.webp',
    comment: '수냉 속성 1등급 지휘관입니다.',
  ),
  AchievementBadgeDefinition(
    id: 'first_class_wind',
    name: '풍둔',
    condition: '풍압 속성 우월코드 합산 상위 4% 이내 달성',
    imagePath: 'assets/icons/elements/icon-elements-Wind.webp',
    comment: '풍압 속성 1등급 지휘관입니다.',
  ),
  AchievementBadgeDefinition(
    id: 'first_class_electric',
    name: '뇌둔',
    condition: '전격 속성 우월코드 합산 상위 4% 이내 달성',
    imagePath: 'assets/icons/elements/icon-elements-Electric.webp',
    comment: '전격 속성 1등급 지휘관입니다.',
  ),
  AchievementBadgeDefinition(
    id: 'first_class_iron',
    name: '토둔',
    condition: '철갑 속성 우월코드 합산 상위 4% 이내 달성',
    imagePath: 'assets/icons/elements/icon-elements-Iron.webp',
    comment: '철갑 속성 1등급 지휘관입니다.',
  ),
  AchievementBadgeDefinition(
    id: 'shoes_20',
