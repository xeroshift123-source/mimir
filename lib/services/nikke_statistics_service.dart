...
class NikkeStatisticsService {
  ...
  static const _accountElementDamageEndpoint =
      'https://us-central1-nikke-mimir.cloudfunctions.net/getAccountElementDamageStatistics';

  Future<AccountElementDamageStatistics> getAccountElementDamageStatistics({
    ...
    try {
      response = await http
          .post(
            Uri.parse(_accountElementDamageEndpoint),
            headers: {
      ...
      throw StateError('속성별 우월코드 통계 응답이 지연되고 있습니다.');
    }
    ...
    if (decoded is! Map<String, dynamic> ||
      ...
      throw StateError(message ?? '속성별 우월코드 통계를 불러오지 못했습니다.');
    }
    return AccountElementDamageStatistics.fromJson(
