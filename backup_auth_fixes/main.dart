...
Future<void> main() async {
  ...
  try {
    ...
    debugPrint("✔ MIMIR Main: Firebase initialized successfully.");
  } catch (e, stackTrace) {
    debugPrint("⚠️ Firebase init exception in main(): $e\n$stackTrace");
  }
...
class _MimirAppState extends State<MimirApp> {
  ...
  Future<void> _initAsyncServices() async {
    try {
      await CpCalculator.init().timeout(const Duration(seconds: 5));
    } catch (e) {
      debugPrint("CpCalculator init background info: $e");
    }
  }
